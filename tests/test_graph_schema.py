...
def test_node_kinds_complete():
    assert set(NODE_KINDS) == {"Concept", "Source", "Evidence", "Advisory", "Subsystem", "Proposal", "KernelInvariant", "FailureMode", "InteractionProtocol"}
...
def test_edge_kinds_complete():
    expected = {
        ...
        "assessed-by", "grounded-in", "governed-by", "triggered-by", "constrains-composition",
    }
